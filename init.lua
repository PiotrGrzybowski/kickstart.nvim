...
-- Force Python indentation with higher priority
...
require('lazy').setup({
  ...
  { -- Detect tabstop and shiftwidth automatically
    ...
    opts = {
      filetype_exclude = { 'python' }, -- Exclude python from auto-detection
    },
  },
    ...
    opts = {
      ...
      formatters = {
        clang_format = {
          ...
          args = { '--style=file' }, -- or e.g., "--style=Google"
          stdin = true,
        },
      },
    },
